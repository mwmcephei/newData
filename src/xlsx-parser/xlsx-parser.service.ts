    ...
    if (newlySavedExcelSheet) {
      ...
      for (let i = 0; i < sheet_name_list.length; i++) {
        ...
        if (sheetName !== 'Status Overview' && sheetName !== 'Overview') {
          ...
          let id: number;
          let measureLead: string;  // __EMPTY_29
          let measureSponsor: string; // __EMPTY_30
          ...
          if (statusReportAsJsonObject[i + 3]['__EMPTY_29'] && statusReportAsJsonObject[i + 3]['__EMPTY_30']) {    // phone numbers exist
