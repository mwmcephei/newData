...
let ApiService = class ApiService {
    ...
    async setAllNotificationsToSeen() {
        try {
    ...
    async handleFileUpload(originalname, targetFileName) {
        const fs = require('fs');
        try {
            await fs.promises.rename(globalVars_1.rootPath + '/files/' + originalname, globalVars_1.rootPath + '/data/' + targetFileName);
            return true;
        }
        catch (err) {
...
ApiService = __decorate([
    ...
    __param(4, (0, mongoose_1.InjectModel)('PastBudget')),
    __param(5, (0, mongoose_1.InjectModel)('Notification')),
    __param(6, (0, mongoose_1.InjectModel)('NotificationStatus')),
    __param(7, (0, mongoose_1.InjectModel)('Upload')),
